...
def run_multihead_self_attention(
    ...
    mha = MultiheadSelfAttention(d_model, num_heads, max_seq_len=seq_len, rope_theta=None)
...
def run_multihead_self_attention_with_rope(
    ...
    Returns:
        ...
        implementation with the given QKV projection weights and input features.
    """
    mha = MultiheadSelfAttention(d_model, num_heads, max_seq_len=max_seq_len, rope_theta=theta)
    mha.q_proj.weight.data = q_proj_weight
    mha.k_proj.weight.data = k_proj_weight
    mha.v_proj.weight.data = v_proj_weight
    mha.output_proj.weight.data = o_proj_weight
